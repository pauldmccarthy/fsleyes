...
# 2D meshes
-s3d -rot  45  45  45 mesh_2d_x.vtk -mc 1 0 0 mesh_2d_y.vtk -mc 0 1 0 mesh_2d_z.vtk -mc 0 0 1
-s3d -rot -45 -45 -45 mesh_2d_x.vtk -cm blue-lightblue -vd mesh_2d_data.txt mesh_2d_y.vtk -cm red-yellow -vd mesh_2d_data.txt  mesh_2d_z.vtk -cm green -vd mesh_2d_data.txt
"""
