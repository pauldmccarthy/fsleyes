...
labels = TypeDict({
    ...
    'OverlayDisplayPanel.VolumeOpts.vol'    : 'Volume settings',
    'OverlayDisplayPanel.VolumeOpts.colour' : 'Colour settings',
    'OverlayDisplayPanel.VolumeOpts.ranges' : 'Display ranges',
    'OverlayDisplayPanel.VolumeOpts.3d'     : '3D settings',
    'OverlayDisplayPanel.MaskOpts.opts'     : 'Mask settings',
    'OverlayDisplayPanel.LabelOpts.opts'    : 'Label settings',
    'OverlayDisplayPanel.MIPOpts.vol'       : 'Volume settings',
    'OverlayDisplayPanel.MIPOpts.colour'    : 'Colour settings',
    'OverlayDisplayPanel.MIPOpts.ranges'    : 'Display ranges',
    'OverlayDisplayPanel.MIPOpts.mip'       : 'MIP settings',

    'OverlayDisplayPanel.VolumeRGBOpts.vol'     : 'RGB(A) volume settings',
    'OverlayDisplayPanel.VolumeRGBOpts.colour'  : 'Colour settings',

    'OverlayDisplayPanel.TractogramOpts.opts'     : 'Tractogram settings',
    'OverlayDisplayPanel.TractogramOpts.pseudo3d' : '3D settings',
    'OverlayDisplayPanel.TractogramOpts.colour'   : 'Colour settings',
    'OverlayDisplayPanel.TractogramOpts.ranges'   : 'Display ranges',
    'OverlayDisplayPanel.TractogramOpts.vector'   : 'Orientation colour settings',

    'OverlayDisplayPanel.MeshOpts.mesh'   : 'Mesh settings',
    'OverlayDisplayPanel.MeshOpts.data'   : 'Mesh data',
    'OverlayDisplayPanel.MeshOpts.colour' : 'Colour settings',
    'OverlayDisplayPanel.MeshOpts.ranges' : 'Display ranges',
    'OverlayDisplayPanel.MeshOpts.3d'     : '3D settings',

    'OverlayDisplayPanel.NiftiVectorOpts.ranges' : 'Display ranges',
    'OverlayDisplayPanel.NiftiVectorOpts.vector' : 'Orientation colour settings',

    'OverlayDisplayPanel.RGBVectorOpts.opts'  : 'Colour settings',
    'OverlayDisplayPanel.LineVectorOpts.opts' : 'Colour settings',
    'OverlayDisplayPanel.LineVectorOpts.line' : 'Line settings',

    'OverlayDisplayPanel.TensorOpts.opts'     : 'Colour settings',
    'OverlayDisplayPanel.TensorOpts.tensor'   : 'Tensor settings',
    'OverlayDisplayPanel.SHOpts.opts'         : 'Colour settings',
    'OverlayDisplayPanel.SHOpts.sh'           : 'SH settings',
...
properties = TypeDict({
    ...
    'LightBoxOpts.reverseSlices'  : 'Reverse slice order',
    'LightBoxOpts.reverseOverlap' : 'Reverse slice overlap',
    ...
    'ColourMapOpts.custom_linkRanges'    : 'Link display/clipping ranges',
...
anatomy = TypeDict({
    ...
    ('Nifti', 'space', constants.NIFTI_XFORM_TEMPLATE_OTHER) : 'Other template',
