...
.. |fsl_version|     replace:: 6.0.7.22

.. |fsleyes_homepage| replace:: FSLeyes
.. _fsleyes_homepage: https://fsl.fmrib.ox.ac.uk/fsl/docs/utilities/fsleyes.html

.. |fsleyes_apidoc| replace:: ``fsleyes``
.. _fsleyes_apidoc: http://open.oxcin.ox.ac.uk/pages/fsl/fsleyes/fsleyes/apidoc/

.. |fslpy_doc| replace:: ``fslpy``
.. _fslpy_doc: http://open.oxcin.ox.ac.uk/pages/fsl/fslpy/

.. |props_doc| replace:: ``fsleyes-props``
.. _props_doc: http://open.oxcin.ox.ac.uk/pages/fsl/fsleyes/props/

.. |widgets_doc| replace:: ``fsleyes-widgets``
.. _widgets_doc: http://open.oxcin.ox.ac.uk/pages/fsl/fsleyes/widgets/
"""
...
# latex_documents = [
#   ('index', 'FSLeyes.tex', u'FSLpy Documentation',
