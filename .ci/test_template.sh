...
FSLEYES_TEST_GL=1.4 MPLBACKEND='wxagg' xvfb-run -s "-screen 0 640x480x24" python setup.py test --addopts="--cov-report= --cov-append"
sleep 5
FSLEYES_TEST_GL=2.1 MPLBACKEND='wxagg' xvfb-run -s "-screen 0 640x480x24" python setup.py test --addopts="--cov-report= --cov-append tests/test_overlaytypes.py"
