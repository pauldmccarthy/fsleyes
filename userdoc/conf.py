...
.. _fsleyes_apidoc: http://git.fmrib.ox.ac.uk/paulmc/fsleyes/

.. |fslpy_doc| replace:: ``fslpy``
.. _fslpy_doc: http://git.fmrib.ox.ac.uk/paulmc/fslpy/

.. |props_doc| replace:: ``props``
.. _props_doc: http://git.fmrib.ox.ac.uk/paulmc/fsleyes-props/
"""
