...
have another image in the same space (e.g. a fractional anisotropy [FA] or
mean diffusivity [MD] map), you can modulate the brightness of the vector
colours in each voxel according to the values in the other image.
...
.. sidebar:: Line vector orientation
             ...
             orientation for the data to be displayed correctly.
...
- **Suppresssion mode** What to do when a component is suppressed - you can
